...
#include "p4_pdpi/test_helper.h"
#include "p4_pdpi/translation_options.h"
#include "p4_pdpi/union_main_p4_pd.pb.h"
          ...
          action {
            replicate {
              replicas {
                port: "some_port"
                instance: "0x0002"
                backup_replicas { port: "some_other_port" instance: "0x0001" }
                backup_replicas { port: "third_port" instance: "0x0003" }
              }
              replicas {
                port: "some_other_port"
                instance: "0x0002"
                backup_replicas { port: "some_port" instance: "0x0001" }
              }
            }
          }
          metadata: "my_metadata"
          ...
          action {
            replicate {
              replicas {
                port: "some_port"
                instance: "0x0001"
                backup_replicas { port: "some_port" instance: "0x0002" }
              }
            }
          }
          metadata: "my_metadata"
          ...
          action {
            replicate {
              replicas {
                port: "some_port"
                instance: "0x0001"
                backup_replicas { port: "some_other_port" instance: "0x0002" }
              }
              replicas { port: "some_other_port" instance: "0x0002" }
            }
          }
          metadata: "my_metadata"
        }
