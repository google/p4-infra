...
// TODO: b/317362020 - A temporary dependence on SAI to mask a bug. Safe to
// remove in April 2024.
#include "gutil/status.h"
#include "third_party/pins_infra/sai_p4/instantiations/google/versions.h"
#include "third_party/pins_infra/thinkit/switch.h"
...
P4RuntimeSession::P4RuntimeSession(
    uint32_t device_id,
    std::unique_ptr<p4::v1::grpc::P4Runtime::StubInterface> stub,
...
// TODO: b/317373445 - Move to Sequencing to replace SequencePiUpdates...
