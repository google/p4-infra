...
3.  Create a new release on Github with the tag being in the form `yyyymmdd.p`,
    the title being `P4 Infra yyyymmdd.p (month year)`, and the corresponding
...
4.  The
    [Bazel Central Registry for p4-infra](https://github.com/bazelbuild/bazel-central-registry/tree/main/modules/p4_infra)
