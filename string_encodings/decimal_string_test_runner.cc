...
int main() {
  ...
  TEST_STATUSOR(string_encodings::IntToDecimalString(uint32_t{4294967295}));
  TEST_STATUSOR(string_encodings::IntToDecimalString(int64_t{9223372036854775807}));
  TEST_STATUSOR(string_encodings::IntToDecimalString(uint64_t{18446744073709551615U}));
  // octal literal.
